    ...
    <div className='checkout-list' >
      <form onSubmit={(e) => handleSubmint(e)}>
        <div className="checkout-list__name">
          ...
          <input id='name' name='username' type="text" defaultValue={user.name || ''} placeholder='Name' required />
        </div>
        <div className='checkout-list__location'>
          <div className="checkout-list__phone">
            <label htmlFor="phone">Telephone</label>
            <input id='phone' name='tel' type="tel" placeholder='Telephone' pattern='[0-9]{9}' required />
          </div>
        ...
        {
          pay ? <div className="checkout-list__card">
            <label htmlFor="number">Card number
              <input className="checkout-list__card__num" id='number' />
            </label>
            <label htmlFor="year">Expiration
              <input className="checkout-list__card__year" type="tel" id='year' />
            </label>
        ...
        <div className='checkout-list__buttons'>
          ...
          <button className='checkout-list__pay' type='submit' disabled={!items.length || loading}>Pay</button>
        </div>
      </form>
